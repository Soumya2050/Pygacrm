...
public class VendorPopupPage {
	 ...
	 * @param vendorname
	 * @return vendor_in_list
	 */
	public WebElement getSearchedVendor(WebDriver driver, String vendorname) {
		WebElement vendor_in_list = driver.findElement(By.xpath("//a[.='"+vendorname+"']"));
		return vendor_in_list;
	}
