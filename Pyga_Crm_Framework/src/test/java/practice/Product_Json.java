...
public class Product_Json {
	...
	public static void main(String[] args) throws InterruptedException, Exception {
		...
		Object obj = p.parse(new FileReader("./src/main/resources/commondata.json"));
		
		//downcast the obj into json object so that automatically all willbe stored
		// in the foem of key value
		...
		String browser=System.getProperty("browser", (String) map.get("browser"));
		...
		driver.get(System.getProperty("url",(String) map.get("url")));
		driver.findElement(By.xpath("//input[@name='user_name']")).sendKeys(System.getProperty("username", (String) map.get("username")));
		driver.findElement(By.xpath("//input[@name='user_password']")).sendKeys(System.getProperty("password", (String) map.get("password")));
